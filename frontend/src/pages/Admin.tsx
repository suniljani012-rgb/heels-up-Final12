...
export default function Admin() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f5f5f4] text-neutral-900 font-sans relative">
      {/* Floating Toasts container */}
      <div className="fixed top-5 right-5 z-50 space-y-3 w-80 pointer-events-none">
        {toasts.map((toast) => (
          <div
      ...
      {/* Sidebar Panel */}
      <aside className={`w-64 bg-white border-r border-neutral-200/80 flex flex-col justify-between shrink-0 h-screen z-30 transition-transform fixed left-0 top-0 md:sticky md:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        {/* Brand */}

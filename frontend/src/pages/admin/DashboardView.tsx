...
export default function DashboardView({ data, products, returns, onTabChange }: DashboardViewProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-in text-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-[#171715] to-[#0e0e0d] border border-neutral-900 rounded-3xl p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="absolute -right-16 -top-16 w-44 h-44 bg-primary/10 rounded-full blur-3xl"></div>
        <div className="space-y-1.5 relative z-10">
          <span className="text-[9px] uppercase tracking-widest font-black text-primary flex items-center gap-1.5">
          ...
          <p className="text-xs text-neutral-400">Real-time e-commerce logs and retail metrics registry</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-[#0f0f0e] border border-neutral-900 rounded-3xl p-5 hover:border-primary/40 transition-all duration-300 relative group overflow-hidden">
          <div className="absolute right-0 top-0 w-24 h-24 bg-primary/5 rounded-full translate-x-6 -translate-y-6 group-hover:scale-110 transition-transform"></div>
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest block">Total Revenue</span>
              <h3 className="text-2xl font-bold font-mono tracking-tight text-white group-hover:text-primary transition-colors">
                {formatCurrency((data?.total_sales || 0) + (data?.total_pos_sales || 0))}
              </h3>
            </div>
            <div className="p-3 bg-[#171715] border border-neutral-850 rounded-2xl text-primary">
              <Wallet className="w-5 h-5" />
            </div>
          </div>
          <div className="mt-4 pt-3 border-t border-neutral-900/60 flex items-center justify-between text-[10px] text-neutral-400 font-mono">
        ...
        <div className="bg-[#0f0f0e] border border-neutral-900 rounded-3xl p-5 hover:border-primary/40 transition-all duration-300 relative group overflow-hidden">
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest block">Total Orders</span>
              <h3 className="text-2xl font-bold font-mono tracking-tight text-white group-hover:text-primary transition-colors">
        ...
        <div className="bg-[#0f0f0e] border border-neutral-900 rounded-3xl p-5 hover:border-primary/40 transition-all duration-300 relative group overflow-hidden">
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest block">Catalog Products</span>
              <h3 className="text-2xl font-bold font-mono tracking-tight text-white group-hover:text-primary transition-colors">
                {products.length}
              </h3>
            </div>
        ...
        <div className="bg-[#0f0f0e] border border-neutral-900 rounded-3xl p-5 hover:border-primary/40 transition-all duration-300 relative group overflow-hidden">
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest block">Pending Exchanges</span>
              <h3 className="text-2xl font-bold font-mono tracking-tight text-white group-hover:text-primary transition-colors">
          ...
          <div className="mt-4 pt-3 border-t border-neutral-900/60 flex items-center justify-between text-[10px] text-neutral-400 font-mono">
            ...
            <button onClick={() => onTabChange('returns')} className="text-primary hover:underline flex items-center gap-0.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#0f0f0e] border border-neutral-900 rounded-3xl p-6 space-y-4">
          <div className="flex items-center justify-between border-b border-neutral-900 pb-3">
            <span className="text-xs font-bold uppercase tracking-widest text-white flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-primary animate-pulse" /> Revenue Trend (Last 7 Days)
            </span>
            <button
              onClick={() => setCollapsedSalesTrend(!collapsedSalesTrend)}
              className="text-[9px] text-neutral-400 hover:text-white uppercase tracking-widest font-bold font-mono"
            >
          ...
          {!collapsedSalesTrend && (
            <div className="relative pt-4">
              <svg className="w-full h-64 overflow-visible" viewBox="0 0 700 240" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Y Grid Lines */}
                <line x1="45" y1="20" x2="675" y2="20" stroke="#1c1c1a" strokeWidth="1" />
                <line x1="45" y1="70" x2="675" y2="70" stroke="#1c1c1a" strokeWidth="1" />
                <line x1="45" y1="120" x2="675" y2="120" stroke="#1c1c1a" strokeWidth="1" />
                <line x1="45" y1="170" x2="675" y2="170" stroke="#1c1c1a" strokeWidth="1" />
                <line x1="45" y1="220" x2="675" y2="220" stroke="#2b2b28" strokeWidth="1.5" />
                  ...
                  <g key={idx} className="group/node">
                    ...
                    <g className="opacity-0 group-hover/node:opacity-100 transition-opacity duration-200">
                      <rect
                        ...
                        height="20"
                        rx="6"
                        className="fill-[#171715] stroke-neutral-800 stroke"
                      />
                      <text
                        x={p.x}
                        y={p.y - 19}
        ...
        <div className="space-y-6">
          {/* Category mix */}
          <div className="bg-[#0f0f0e] border border-neutral-900 rounded-3xl p-6 space-y-4">
            <div className="flex items-center justify-between border-b border-neutral-900 pb-3">
              <span className="text-xs font-bold uppercase tracking-widest text-white">Category Share</span>
              <button
              ...
              <div className="space-y-3.5 pt-2">
                {catShare.map((cat: any, idx: number) => (
                  <div key={idx} className="space-y-1.5">
                    <div className="flex justify-between text-[11px] font-mono text-neutral-350">
                      <span>{cat.category || 'Oxford Shoes'}</span>
                      <span className="text-primary font-bold">{cat.value || 0}%</span>
                    </div>
                    <div className="h-1.5 bg-[#171715] rounded-full overflow-hidden border border-neutral-900/40">
                      <div
          ...
          <div className="bg-[#0f0f0e] border border-[#ef4444]/15 rounded-3xl p-6 space-y-4">
            ...
            <div className="space-y-3 pt-2 max-h-40 overflow-y-auto pr-1">
              {products.filter(p => p.stock <= 5).slice(0, 5).map((prod) => (
                <div key={prod.id} className="flex justify-between items-center p-2.5 bg-[#1a0e0e]/30 border border-[#ef4444]/10 rounded-xl text-xs font-mono">
                  <span className="truncate max-w-[130px] font-bold text-neutral-300">{prod.name}</span>
                  <span className="text-[10px] bg-[#ef4444]/20 border border-[#ef4444]/20 text-rose-400 px-1.5 py-0.5 rounded font-extrabold">
                    {prod.stock} stock
                  </span>
                </div>
              ))}
